...
namespace Fusion.CLI.Metadata
{
    public sealed class FieldMarshalData
    {
        ...
        {
            if ((pFile.CLIMetadataTablesHeader.PresentTables & (1ul << CLIMetadataTables.FieldMarshal)) != 0)
            {
        ...
        private void LoadData(CLIFile pFile)
        {
            ...
            NativeType = pFile.ReadBlobHeap(pFile.ReadHeapIndex(CLIHeapOffsetSize.Blob32Bit));
        }
